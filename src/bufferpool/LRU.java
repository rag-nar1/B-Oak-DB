...
public class LRU implements Replacer {
  ...
  /**
   * evict the frame with the largest k-distance in case if two frames tie with the INF we break the
   * tie with who has the latest access and evict the other also we skip any unevictable frames
   *
